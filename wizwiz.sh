...
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/masihloo/settings/messagewizwiz.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/masihloo/settings/rewardReport.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/masihloo/settings/warnusers.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/masihloo/settings/gift2all.php >/dev/null 2>&1") | sort - | uniq - | crontab -
...
wait
    ...
    if [[ $(mysql -u root -p$ROOT_PASSWORD -e "SHOW DATABASES LIKE 'wizwiz'") ]]; then
        ...
        file_path="/var/www/html/masihloo/baseInfo.php"
        ...
        # print file
        echo -e "<?php" >> /var/www/html/masihloo/baseInfo.php
        echo -e "error_reporting(0);" >> /var/www/html/masihloo/baseInfo.php
        echo -e "${ASAS}botToken = '${YOUR_BOT_TOKEN}';" >> /var/www/html/masihloo/baseInfo.php
        echo -e "${ASAS}dbUserName = '${dbuser}';" >> /var/www/html/masihloo/baseInfo.php
        echo -e "${ASAS}dbPassword = '${dbpass}';" >> /var/www/html/masihloo/baseInfo.php
        echo -e "${ASAS}dbName = '${dbname}';" >> /var/www/html/masihloo/baseInfo.php
        echo -e "${ASAS}botUrl = 'https://${YOUR_DOMAIN}/masihloo/';" >> /var/www/html/masihloo/baseInfo.php
        echo -e "${ASAS}admin = ${YOUR_CHAT_ID};" >> /var/www/html/masihloo/baseInfo.php
        echo -e "?>" >> /var/www/html/masihloo/baseInfo.php

        sleep 1

        curl -F "url=https://${YOUR_DOMAIN}/masihloo/bot.php" "https://api.telegram.org/bot${YOUR_BOT_TOKEN}/setWebhook"
        ...
        url="https://${YOUR_DOMAIN}/masihloo/createDB.php"
        curl $url
        
        sleep 1
        
        sudo rm -r /var/www/html/masihloo/webpanel
	    sudo rm -r /var/www/html/masihloo/install
	    sudo rm /var/www/html/masihloo/createDB.php
