...
$mainValues = [
    'banned' => '❌ | کاربر گرامی به دلیل نقض قوانین ، حساب شما مسدود گردید 😑😂',
    ...
    'customer_custome_plan_name'=>'لطفا برای اکانت خود یک نام از ترکیب حروف کوچک انگلیسی به همراه عدد وارد کنید 🙏',
    ...
    'increase_wallet_cart_to_cart'=>"♻️ دوست عزیز ، لطفا مبلغ شارژ مورد نظر را به شماره کارت زیر واریز کنید و یک عکس از رسید واریز را در همین قسمت برای ما ارسال کنید  :
    
    🟢جهت کپی , روی آن ضربه بزنین🟢
            👇👇👇👇👇👇👇👇
            🔰 <code>ACCOUNT-NUMBER</code> 🔰
    
    🟥 تایید پرداخت در کمتر از 5 دقیقه 🟥",
    ...
    'reached_main_menu'=>"سلام مجدد  🌸

    به ربات مسیحلو خوش آمدید 🫡
    
    ما اینجاییم تا شما عزیزان بدون هیچ محدویتی به اینترنت آزاد دسترسی داشته باشید ❤️
...
💰مبلغ: PRICE تومان
🧑‍💻 نام و نام خانوادگی : <a href='tg://user?id=USER-ID'>NAME</a>
🎯 یوزرنیم : @USERNAME
...
'buy_account_cart_to_cart'=>"♻️ دوست عزیز ، لطفا مبلغ پلن مورد نظر را به شماره کارت زیر واریز کنید و یک عکس از رسید واریز را در همین قسمت برای ما ارسال کنید  :
...
🟥 تایید پرداخت در کمتر از 5 دقیقه 🟥",
'renew_ccount_cart_to_cart'=>"♻️ دوست عزیز ، لطفا مبلغ شارژ مورد نظر را به شماره کارت زیر واریز کنید و یک عکس از رسید واریز را در همین قسمت برای ما ارسال کنید  :
...
🔮 نام سرویس: REMARK
💮 سفارش: FILENAME",
'renew_order_sent'=>"✅| دوست عزیز ، درخواست شما با موفقیت ثبت شد، بعد از بررسی ادمین ، کانفیگ برای شما ارسال خواهد شد",
...
",
    'bot_is_updating'=> "🌛ربات در حال بروزرسانی می باشد لطفا دقایقی دیگر مجددا امتحان کنید ...",
    'select_one_to_show_detail'=> ' 🔅 برای مشاهده مشخصات روی اکانت مورد نظر خود بزنید :',
    'you_dont_have_config'=>'شما هیچ سفارشی ندارید ',
...
⁮⁮ ⁮⁮ ⁮⁮ ⁮⁮
",
'please_wait_message2'=>"✅ کانفیگ تغییر کرد . از همین صفحه اقدام به کپی کنید ✅ ",
'please_wait_message'=>"🙃 | لطفا منتظر باشید",
'send_only_number'=> "لطفا فقط اعداد انگلیسی ارسال کنید",
...
'send_your_phone_number'=>"سلام ، دوست عزیز برای استفاده از ربات شماره تماس خود را با استفاده از کلید زیر ارسال کنید . شماره شما جهت ارتباط در موقع ضروری نزد ما به امانت خواهد ماند 👇",
'start_message'=>'سلام 🌸
...
"not_joine_yet"=>"شما هنوز عضو کانال نشده اید ",
'insert_discount_code'=>"🎁|لطفا کد تخفیف خود را وارد کنید:",
"not_valid_discount_code"=>"😔|کد تخفیفی که وارد کرده اید معتبر نیست",
...
⁮⁮ ⁮⁮",
"send_config_uuid"=>"❗️| لینک کانفیگ یا uuid را ارسال کنید تا اطلاعات کامل برای شما ارسال شود . 🤭",
...
'agency_request_approved'=>"✅ درخواست شما برای نمایندگی تأیید شد ، به منظور آپدیت منو ربات ، یکبار ربات را /start  کنید ",
...
'no_server_available'=>" در حال حاضر هیچ سرور فعالی نداریم لطفا بعدا مجدد تست کنید",
'buy_sub_select_location' => '  1️⃣ مرحله یک:

لطفا اپراتور  خود را برای خرید انتخاب کنید ',
...
لطفا مدت زمان مدنظر خود را انتخاب کنید",
...
لطفا پلن مدنظر خودرا انتخاب کنید ", 
'buy_custom_plan'=>'➕ پلن دلخواه خود را بخرید',
'select_one_plan_to_edit'=>"لطفا یکی از پلن ها را برای شخصی سازی انتخاب کنید ", 
...
حجم سرویس: VOLUME گیگ
مدت زمان سرویس: DAYS روز',
    'sending_config_to_user'=>'🚀 | 😍 در حال ارسال کانفیگ   ...',
    'config_not_found'=>"مشکلی پیش اومده، دوباره از نو انجام بده",
    'incorrect_config_name'=>" اسم وارد شده معتبر نمی باشد . در نظر داشته باشید که اسم باید از ترکیب حروف کوچک انگلیسی و اعداد باشد ❌ ",
...
$buttonValues = [
    ...
    'cancel' => 'انصراف',
    'join_channel'=>"عضویت در کانال اطلاع رسانی",
    'have_joined'=>"عضو شدم ✅",
    'gift_volume_day'=>"🎯 هدیه حجم و زمان",
    'test_account'=>"🚀 دریافت اکانت تست 🚀",
    'invite_friends'=>"🏆 اکانت رایگان",
    'my_info'=>"🧑‍💼 حساب کاربری",
    ...
    'application_links'=>'🧩 آموزش و نرم افزارها',
    'my_tickets'=>"📨 تیکت های من",
    'search_config'=>"🪫 مشخصات اکانت",
    'delete_config'=>"❌ حذف اکانت",
